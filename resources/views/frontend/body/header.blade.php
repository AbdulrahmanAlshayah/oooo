          ...
          <div class="cnt-account">
            <ul class="list-unstyled">
              <li><a href="#"><i class="icon fa fa-user"></i>
                @if(session()->get('language') == 'arabic') حسابك @else My Account @endif
                            </a></li>
              ...
              {{-- @auth  or @guest
                ...
                @else         @else
              @endauth        @endguest           icon fa fa-user/icon fa fa-lock    --}}
              <li>
                @auth
            ...
            <div class="search-area">
              ...
              @csrf
                <div class="control-group">
                  ...
                  <input class="search-field" name="search" onfocus="search_result_show()" onblur="search_result_hide()" id="search" placeholder="Search here..." />
...
<!--   // End Mini Cart Start with Ajax -->
                ...
                <div class="clearfix cart-total">
                  <div class="pull-right"> <span class="text">Sub Total :<span class='price' id="cartSubTotal"> </span> </div>
                  <div class="clearfix"></div>
